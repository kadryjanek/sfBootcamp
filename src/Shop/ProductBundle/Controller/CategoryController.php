...
use Shop\ProductBundle\Form\CategoryFilterType;
...
class CategoryController extends Controller
{
    ...
    */
    protected function filter()
    {
        ...
        $queryBuilder = $em->getRepository('ShopProductBundle:Category')->createQueryBuilder('e');
    ...
    */
     ...
     * @Method("POST")
     * @Template("ShopProductBundle:Category:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ShopProductBundle:Category')->find($id);
     ...
     * @Method("PUT")
     * @Template("ShopProductBundle:Category:edit.html.twig")
     */
